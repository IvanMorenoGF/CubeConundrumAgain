...
public static class Commands
{
    ...
    public static MoveCharacterToAnotherScene DragTo(int fromVignette,int toVignette,int fromPosition, int toPosition) 
        => new(fromVignette,toVignette,fromPosition, toPosition);
